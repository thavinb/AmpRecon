...
include { subset_bam } from './test_tools.nf'
include { compare_bam_subset } from './test_tools.nf'
include { basecalls_conversion } from '../ampseq-NF-pipeline/modules/basecalls_conversion.nf'
include { download_i2b_output_from_s3 } from './download_test_data.nf'
include { download_bcl_from_s3 } from './download_test_data.nf'
