...
# this script was obtained from the Amplicon Nextflow pipeline
# https://gitlab.internal.sanger.ac.uk/sanger-pathogens/pipelines/amplicon/-/blob/main/tests/bin/manifest2tag.py
